...
act_pw = getPower(act,dt_ds,fs_ds_cond,tau);
...
longer_non_cond_latency_idx = tble_edt.latency >=3 & tble_edt.stage ~= "Abs_cond" ; % removing all the detection greater than stimulus presentation
